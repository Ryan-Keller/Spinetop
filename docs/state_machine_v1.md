...
| dispatch/approved | Governed Admission Script | collective | Yes | `admitted_at`, `governance_approval_ref`, `related_petition_id`, `governance_decision_id`, `admission_actor`, `durability_class` | Yes | Warm/Hot may defer | Must verify governance trail |
...
- approved → collective: `admitted_at`, `governance_approval_ref`, `related_petition_id`, `governance_decision_id`, `admission_actor`, `durability_class`
