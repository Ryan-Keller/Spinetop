...
# Provider availability is intentionally validated lazily at call time.
# This lets Honcho boot in storage-only mode without LLM credentials, while
# still failing clearly if reasoning/chat features are actually invoked.
